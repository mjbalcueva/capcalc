		...
		return (
			<div>
				<h2 className="text-lg font-medium">
					{label} <span className="text-sm tracking-wide text-muted-foreground">{symbol && `(${symbol})`}</span>
				</h2>
				<p
					ref={ref}
					className={cn(
						'font-mono text-4xl font-bold',
						(children === 0 || children === 'None') && 'text-[#d3d3d6] dark:text-[#4a4a50]'
					)}
					{...props}
				>
					{children}
...
export { useFormField, Form, FormItem, FormLabel, FormControl, FormDescription, FormMessage, FormOutput, FormField }
